            ...
            <Dialog v-model:visible="visible">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control" id="nomCategorie" v-model="sCategorie.nomSCategorie"/>
                    </div>
                </div>
                <br />
                <button
...
const loadScategorie = () => {
    console.log(props.form);
    sCategorie.value = props.form;
    console.log(sCategorie.value);
...
const modifiercategorie = () => {
    axios
        .put(
            `http://localhost:8000/api/s_categories/${sCategorie.value.id}`,
            sCategorie.value
        )
        .then(() => {
            visible.value = false;
